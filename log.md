...
**Today's Progress**: Start writing easy go web server and unit testing

**Thoughts**: After spent 4-5 days on golang, I desire to explore more on golang unit testing and documenting. I found that there is a official autogenerated-document tool for golang. I will try that and start mastering golang test while, in parallel, writing the document


### Day 30: Feb 23, 2020

**Today's Progress**: Complete 1st-week assignment on Algorithms II.
